...
def main(llm, tokenizer, data_name, args):
    ...
    for epoch in range(max_func_call):
        ...
        if args.use_vllm:
            ...
            # lock = Manager().Lock()
            get_client_response_paltial = partial(get_client_response, model_name=args.model_name_or_path, base_url=args.base_url, critic=args.critic, temperature=args.temperature, top_p=args.top_p, max_tokens=args.max_tokens_per_call, n=1, stop=stop_words)
            batch_size = 1
            num_processed = 0
