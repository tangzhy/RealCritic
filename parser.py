...
def extract_answer(pred_str, data_name, use_last_number=True):
    ...
    elif "best answer is" in pred_str:
        pred = pred_str.split("best answer is")[-1].strip()
    elif "correct answer is" in pred_str:
        pred = pred_str.split("correct answer is")[-1].strip()
    ...
    # choice answer
    if (
        data_name in ["sat_math", "aqua", "arc-challenge", "gpqa"]
